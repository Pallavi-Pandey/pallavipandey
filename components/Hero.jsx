      ...
      <div className="container  mx-auto">
        <div className='flex justify-between gap-x-8'>
          ...
          <div className="flex max-w-[680px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
            ...
            <h1 className="h1 mb-4">Hello, I'm Pallavi Pandey.</h1>
          ...
          <div className="hidden xl:flex relative">
            ...
            <DevImg
              containerStyles='bg-hero_shape w-[510px] h-[462px] bg-no-repeat relative bg-bottom' imgSrc='/hero/developer.png' />
          </div>
        </div>
