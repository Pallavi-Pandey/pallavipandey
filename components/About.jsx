      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col xl:flex-row">
          ...
          <div className="hidden xl:flex flex-1 relative">
            <DevImg
              containerStyles="bg-about_shape_light dark:bg-about_shape_dark w-[500px] h-[500px]
                ...
                <TabsContent value="personal">
                  <div className="text-center xl:text-left">
                    ...
                    <p className="subtitle max-w-xl mx-auto xl:mx-0">
                      I specialize in crafting intuitive, user-friendly websites
                      that blend creativity with functionality. With a deep
                      understanding of the latest web technologies and design
                      principles, I strive to create digital experiences that
                      engage and inspire. Whether you're looking to build a new
                      website from scratch or revamp an existing one, my goal is
                      to help you achieve your vision with precision and
                      excellence.
                    </p>
                    {/* icons */}
                        ...
                        <div className="flex flex-col gap-y-8">
                          {getData(qualificationData, "experience").data.map(
                            (item, index) => {
                              ...
                              return (
                                <div
                                  className="flex gap-x-8 group bg-primary/10 rounded-lg p-2"
                                  key={index}
                                >
